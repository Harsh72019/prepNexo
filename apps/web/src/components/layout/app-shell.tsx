          ...
          <div className="flex items-center justify-between gap-3">
            ...
            >
              ...
              <span className="min-w-0">
                <span className="block text-base font-black tracking-normal text-foreground sm:text-lg">
                  PrepNexo
                </span>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active &&
                      "border-primary/35 bg-primary text-primary-foreground shadow-[0_12px_34px_hsl(var(--primary)/0.28)]",
                  )}
                >
